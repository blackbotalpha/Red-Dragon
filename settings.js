...
🤷‍♀️How can I help you?😉ප්‍රතික්ෂේප කරපු අයට ආයි මතක් වෙන දවසක් එයි...*🥺

*එදාට දැක්කෙ නැ වගෙ ඉදපන්...*  😂 🤍` //Costomize Alive Message (type your message in `` )
...
global.ownername = "⛬SUNETH BRO⛬" // owner name
...
global.ownertag = '+94768440031' //your tag number
global.botname = '⛬𝗕𝗟𝗔𝗖𝗞╺ 𝘿𝙍𝘼𝙂𝙊𝙉 - 𝘉𝘖𝘛' //ur bot name
global.packname = "Bot Sticker" // sticker packname
global.author = "⛬𝗕𝗟𝗔𝗖𝗞╺ 𝘿𝙍𝘼𝙂𝙊𝙉" // sticker author
global.dragonemoji = '🧩' // Menu emoji
global.footer = '[ ◉ 𝙱𝙻𝙰𝙲𝙺-ᴅʀᴀɢᴏɴ-ᴍᴅ ]' //
